...
for j in manipulate-grid-attackchain recon-attackchain disrupt-communication-attackchain industroyer-attackchain control-freeze-attackchain voltage-drift-off-attackchain 
do
